    ...
    <TypeDemoScreen
      ...
      renderLightSection={guides => (
        <View>
          ...
          <Text style={[iOSUIKit.footnoteEmphasized, guides]}>
            Semi-Bold 23
          </Text>
          <Text style={[iOSUIKit.footnote, guides]}>Regular 23</Text>
          <Text style={[iOSUIKit.caption2Emphasized, guides]}>
            Semi-Bold 20
          </Text>
      ...
      renderDarkSection={guides => (
        <View>
          <Text style={[iOSUIKit.largeTitleEmphasizedWhite, guides]}>
            Bold 44
          </Text>
          <Text style={[iOSUIKit.title3EmphasizedWhite, guides]}>
            Semi-Bold 31
          </Text>
          <Text style={[iOSUIKit.title3White, guides]}>Regular 31</Text>
          <Text style={[iOSUIKit.bodyEmphasizedWhite, guides]}>
            Semi-Bold 28
          </Text>
          <Text style={[iOSUIKit.bodyWhite, guides]}>Regular 28</Text>
          <Text style={[iOSUIKit.subheadEmphasizedWhite, guides]}>
            Semi-Bold 25
          </Text>
          <Text style={[iOSUIKit.subheadWhite, guides]}>Regular 25</Text>
          <Text style={[iOSUIKit.subheadShortWhite, guides]}>
            Regular 25 Short
          </Text>
          <Text style={[iOSUIKit.calloutWhite, guides]}>Regular 26</Text>
          <Text style={[iOSUIKit.footnoteEmphasizedWhite, guides]}>
            Semi-Bold 23
          </Text>
          <Text style={[iOSUIKit.footnoteWhite, guides]}>Regular 23</Text>
          <Text style={[iOSUIKit.caption2EmphasizedWhite, guides]}>
            Semi-Bold 20
          </Text>
